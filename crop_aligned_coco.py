"""Hard crop aligned COCO dataset.

Crops from batch1_coco_p03_aligned:
- left: 100px
- right: 200px
- bottom: 100px
"""
...
SRC = Path(r"F:\Bear\apple\dataset\batch1_coco_p03_aligned")
DST = Path(r"F:\Bear\apple\dataset\batch1_coco_p03_aligned_crop")
...
def process_split(split: str) -> None:
    ...
    # Compute new canvas size from first image (all same size)
